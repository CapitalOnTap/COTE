...
storiesOf('Dropdown', module)
  ...
  .add('InitialOption', () => <Dropdown options={test} selectedOption={test[0]} />)
  .add('Controlled', () => (
    <Dropdown options={test} selectedOption={test[0]} isControllable={true} />
  ))
  .add('Error', () => (
  ...
  .add('With elements for options', () => <Dropdown options={elementOptions} />)
  .add('With elements for title and options', () => (
    <Dropdown title={<h1>H1 Title</h1>} options={elementOptions} />
  ))
